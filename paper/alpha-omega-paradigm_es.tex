...
\title{Alpha-Omega Paradigm: Un Marco Conceptual}
...
\begin{abstract}
Este trabajo introduce Alpha-Omega Paradigm como un nuevo marco conceptual dentro del paradigma Resonance Data y QIRC.
\end{abstract}
