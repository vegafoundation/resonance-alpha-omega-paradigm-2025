...
\title{Alpha-Omega Paradigm: Концептуальная основа}
...
\begin{abstract}
Эта работа представляет Alpha-Omega Paradigm как новую концептуальную основу в рамках парадигмы Resonance Data и QIRC.
\end{abstract}
