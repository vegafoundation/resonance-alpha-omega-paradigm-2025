...
\title{Alpha-Omega Paradigm: Kavramsal Bir Çerçeve}
...
\begin{abstract}
Bu çalışma, Alpha-Omega Paradigm'i Resonance Data ve QIRC paradigması içinde yeni bir kavramsal çerçeve olarak tanıtmaktadır.
\end{abstract}
